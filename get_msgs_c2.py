...
url = "https://jules.googleapis.com/v1alpha/sessions/17116425614251274967/activities?pageSize=100"
...
while url:
    ...
    if token:
        url = f"https://jules.googleapis.com/v1alpha/sessions/17116425614251274967/activities?pageSize=100&pageToken={token}"
    else:
        url = None
