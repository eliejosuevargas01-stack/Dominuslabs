...
keys = ["/home/eliezer/Escritorio/dominuslabs/certs/client.key", "/home/eliezer/Escritorio/dominuslabs/certs/whatsapp_client.key"]
...
for key_path in keys:
    try:
        ...
        print(f"SUCCESS PKCS1v15 with {key_path}!")
        print(plaintext.decode('utf-8'))
        break
    except Exception as e:
        print(f"FAILED PKCS1v15 with {key_path}: {e}")
