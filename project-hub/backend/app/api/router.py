...
from app.api.endpoints import projects, uploads, webhooks, auth, crm, users, whatsapp, health, company_setting, product_media, products, orders, open_delivery, integrations, operational_metrics, events
...
api_router.include_router(operational_metrics.router, prefix="/api/v1", tags=["operational-metrics"])
