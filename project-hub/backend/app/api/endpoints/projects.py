...
def create_task(project_id: int, task_in: ProjectTaskCreate, db: Session = Depends(get_db)):
...
def update_task(task_id: int, task_in: ProjectTaskUpdate, db: Session = Depends(get_db)):
