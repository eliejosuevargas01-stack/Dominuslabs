...
def map_n8n_message(msg: dict, lead_channel: str = "whatsapp") -> List[dict]:
    ...
    if "mensagens" in msg and isinstance(msg["mensagens"], list):
        ...
        for m in msg["mensagens"]:
            ...
            mapped.append({
                ...
                "contact_jid": (m.get("to") or m.get("recipient") or m.get("key", {}).get("remoteJid") or contact_jid) if is_from_me else contact_jid,
    ...
    if "is_from_me" in msg or "message_id" in msg or "contact_jid" in msg or "push_name" in msg or "session_id" in msg or "content" in msg or "chat_kind" in msg:
        ...
        mapped.append({
            ...
            "contact_jid": (msg.get("to") or msg.get("recipient") or msg.get("key", {}).get("remoteJid") or msg.get("contact_jid") or msg.get("jid")) if is_from_me else (msg.get("contact_jid") or msg.get("jid")),
            "is_from_me": is_from_me,
            "sender": sender,
            "direction": direction,
            "sent_by_user": is_from_me,
