...
export default function CampaignsWizardView({
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-violet-100 shadow-sm">
        {[
          ...
          <div className="space-y-6">
            ...
            {segments.length > 0 ? (
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-bold text-slate-900 text-sm">{seg.label}</span>
              ...
              <div className="py-12 text-center text-slate-400 bg-slate-50 rounded-2xl border border-dashed border-slate-200">
                ...
                <p className="text-xs font-semibold text-slate-500">Aguardando lista de segmentos da API...</p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-2xl border border-slate-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none text-sm transition-all"
              />
            </div>
            ...
            <div className="flex items-center justify-between pt-4">
              <button
                ...
                className="inline-flex items-center gap-2 text-slate-600 hover:text-slate-900 font-semibold text-xs px-4 py-2 rounded-xl transition-all cursor-pointer"
              >
        ...
        {currentStep === 3 && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              ...
              <div className="mx-auto w-full max-w-[280px] bg-slate-900 p-4 rounded-[40px] shadow-2xl border-4 border-slate-800 space-y-3">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-purple-50/60 border border-purple-100 text-xs text-purple-900 space-y-1">
                  ...
                  <p className="text-slate-600">Segmento Selecionado: ID {selectedSegmentId || 'Geral'}</p>
                </div>

                <div className="space-y-2">
                  <label className="block text-xs font-bold text-slate-700">Ajustar Redação Gerada (Opcional):</label>
                  <textarea
                    rows={4}
                    value={generatedMessage}
                    onChange={(e) => setGeneratedMessage(e.target.value)}
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs outline-none focus:border-purple-500"
                  />
                </div>
