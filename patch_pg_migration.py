...
# We will just replace the whole migration block with SQLAlchemy text() statements which are safer.
new_migration = """
    # Auto-migration
    try:
