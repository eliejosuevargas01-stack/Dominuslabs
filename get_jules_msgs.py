...
url = "https://jules.googleapis.com/v1alpha/sessions/14332837140454058259/activities?pageSize=100"
...
while url:
    ...
    if token:
        url = f"https://jules.googleapis.com/v1alpha/sessions/14332837140454058259/activities?pageSize=100&pageToken={token}"
    else:
        url = None
