...
export default function ScrapperView() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      {/* Tabs */}
      <div className="flex   p-1.5 rounded-2xl border border-zinc-200 shadow-sm w-fit">
        <button
          onClick={() => setActiveTab('meta')}
          className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all ${
            activeTab === 'meta'
              ? 'bg-blue-600 text-white shadow-md shadow-blue-600/20'
              : 'text-zinc-500 hover:text-zinc-700 hover:'
          }`}
        >
      ...
      {/* Form Card */}
      <div className="surface-card p-6 sm:p-8   border border-zinc-200/30 rounded-2xl shadow-xl transition-all">
        <form onSubmit={handleRunSearch} className="space-y-6">
          
          {/* Queries Area */}
          <div className="space-y-2">
            <label className="block text-sm font-bold text-zinc-700" htmlFor="queries">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl border border-zinc-200  focus:bg-white focus:border-purple-500 focus:ring-2 focus:ring-purple-200/50 outline-none transition-all placeholder:text-zinc-400 text-sm font-medium resize-none"
            />
          ...
          {activeTab === 'meta' && (
            <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="block text-sm font-bold text-zinc-700" htmlFor="metaMinResults">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-zinc-200  focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200/50 outline-none transition-all text-sm font-semibold"
                  />
                  <p className="text-[11px] text-zinc-400">Padrão: 5</p>
                </div>

                <div className="space-y-2">
                  <label className="block text-sm font-bold text-zinc-700" htmlFor="metaMaxResults">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-zinc-200  focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200/50 outline-none transition-all text-sm font-semibold"
                  />
                  <p className="text-[11px] text-zinc-400">Padrão: 20</p>
                </div>
              </div>
                      ...
                      <button
                        ...
                        className={`flex items-center justify-center p-3 rounded-xl border text-xs font-semibold transition-all cursor-pointer ${
                          selected
                            ...
                            : 'border-zinc-200  hover:bg-white hover:border-purple-200 text-zinc-600'
                        }`}
                      >
                        {platform.label}
                      </button>
          ...
          {activeTab === 'maps' && (
            <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="space-y-2">
                <label className="block text-sm font-bold text-zinc-700" htmlFor="mapsMaxResults">
                  Máximo de Resultados
                </label>
                <input
                  id="mapsMaxResults"
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-zinc-200  focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200/50 outline-none transition-all text-sm font-semibold"
                />
                <p className="text-[11px] text-zinc-400">Padrão: 50. O Google Maps não utiliza target_platform.</p>
              </div>
            </div>
          )}
          ...
          <div className="space-y-2 pt-4 border-t border-zinc-200/50">
            <label className="flex items-center gap-1.5 text-sm font-bold text-zinc-700" htmlFor="webhookUrl">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-zinc-200 bg-zinc-50 focus:bg-white focus:border-purple-500 focus:ring-2 focus:ring-purple-200/50 outline-none transition-all text-xs font-medium placeholder:text-zinc-400"
            />
            <p className="text-[11px] text-zinc-400">
