  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-1.5 text-xs font-semibold text-slate-500">
        ...
        <span className="font-display text-purple-800 bg-purple-100/80 px-2 py-0.5 rounded-full">{clampedProgress}% Concluído</span>
      </div>
      <div className="w-full bg-slate-100/80 border border-slate-200/50 rounded-full h-3.5 overflow-hidden p-[2px]">
        <div
          className="bg-gradient-to-r from-purple-600 via-indigo-500 to-emerald-500 h-full rounded-full transition-all duration-700 cubic-bezier(0.4, 0, 0.2, 1) relative shadow-[inset_0_1px_0_rgba(255,255,255,0.15)]"
